...
Effectively extracted pricing data from multiple sources and formats using **Python**. Created visualizations for storytellind and analysis using **Matplotlib**. Leveraged the data collected to develop a pricing differential based on an OPIS Average benchmark for 87 RFG Gasoline out of Baltimore. 
